        ...
        <div class="main-wrap">
            <fieldset>
                ...
                <div class="block-error-msg">
                    ...
                    <small class="blocker-7-setting-small">enter a general error message that will displayed if any of the above values found in the form</small>
                ...
                <div class="block-get-log">
                    <h4 class="blocker-7-setting second">To download and view the log file <a href="/wp-content/spcf_spam_block.log">click here</a></h4>
                </div>
            </fieldset>
        </div>
        <?php
